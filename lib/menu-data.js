...
// --- Demo placeholders: filler cards to showcase scrolling. ---
// Spread across all three categories and added to "Highly Rated" so both the
// home screen and the category pages scroll. Delete this block (and the spread
// in highlyRatedIds / items below) to remove them.
const PLACEHOLDER_COUNT = 12;
const placeholderItems = Array.from({ length: PLACEHOLDER_COUNT }, (_, i) => {
...
export const items = [...baseItems, ...placeholderItems];

const highlyRatedIds = [
  'cappuccino', 'iced-latte', 'bruschetta', 'caesar-salad', 'milkshake', 'garlic-bread',
  ...placeholderItems.map((i) => i.id),
];
